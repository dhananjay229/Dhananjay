  ...
  return (
    <><>
      ...
      <Head>
        ...
        <meta property="og:title" content="Homepage | Dhananjay Kumar portfolio" />
        ...
        <div className="container relative z-30 pt-20 pb-12 sm:pt-48 sm:pb-50 lg:pt-50 lg:pb-48">
          ...
          <div className="flex flex-col items-center justify-center lg:flex-row">
            ...
            <Link href="https://www.linkedin.com/in/dhananjay45423/">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16"
                className="bi bi-linkedin text-cyan-500 hover:text-white">
          ...
          <a href="#" className="mx-4">
            <Link href="mailto:dhananjay45423@gmail.com">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16"
                className="bi bi-envelope text-cyan-500 hover:text-white" >
