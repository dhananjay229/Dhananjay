...
const onButtonClick = () => {
  ...
  fetch('Dhananjay_resume.pdf').then(response => {
    response.blob().then(blob => {
      ...
      alink.href = fileURL;
      alink.download = 'Dhananjay_resume.pdf';
      alink.click();
    })
  })
}
  ...
  return (<><>
    ...
    <div>
      ...
      <Head>
        ...
        <script defer src="https://unpkg.com/alpinejs@3.x.x/dist/cdn.min.js" async></script>
            ...
            <div className=" mt-10 flex flex-row items-center space-x-8">
              ...
              <a href="#" className="">
                <Link href="mailto:dhananjay45423@gmail.com">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 16 16"
                    className="bi bi-envelope text-[#130F49] hover:text-cyan-500" >
                    <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z" />
                  </svg>
                </Link>
              </a>
              <a href="#" className="">
                <Link href="https://www.linkedin.com/in/dhananjay45423/">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 16 16"
                    className="bi bi-linkedin text-[#130F49] hover:text-cyan-500">
              ...
              <a href="#" className="">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 16 16"
                  className="bi bi-globe text-[#130F49] hover:text-cyan-500"  >
